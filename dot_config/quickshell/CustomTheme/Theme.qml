...
QtObject { 
    ...
    property color inverse_primary: "#d649ae"
    property color inverse_surface: "#f1dfdb"
    property color on_background: "#f1dfdb"
    property color on_error: "#690005"
    property color on_error_container: "#ffdad6"
    property color on_primary: "#241523"
    property color on_primary_container: "#241523"
    property color on_primary_fixed: "#241523"
    property color on_primary_fixed_variant: "#241523"
    ...
    property color primary: "#d649ae"
    property color primary_container: "#d649ae"
    property color primary_fixed: "#d649ae"
    property color primary_fixed_dim: "#d649ae"
    ...
    property color source_color: "#d649ae"
    ...
    property color surface_tint: "#d649ae"
