...
Item {
    ...
    readonly property color foregroundColor: Config.passwordInputContentColor
    readonly property bool hasClockContent: Config.clockDisplay || Config.dateDisplay
    readonly property bool hasMessageContent: Config.lockMessageDisplay
    Item {
        id: infoBackdrop
        z: -1
        visible: !!lockScreen.backgroundSource && (lockScreen.hasClockContent || lockScreen.hasMessageContent)
        x: 0
        ...
        ShaderEffectSource {
            id: backdropSource
            anchors.fill: parent
            sourceItem: lockScreen.backgroundSource
            live: true
            hideSource: false
            sourceRect: Qt.rect(infoBackdrop.x, 0, infoBackdrop.width, infoBackdrop.height)
        }
    ...
    ColumnLayout {
        ...
        Text {
            ...
            color: lockScreen.foregroundColor
    ...
    ColumnLayout {
        ...
        Item {
            ...
            MultiEffect {
                ...
                colorizationColor: lockScreen.foregroundColor
