...
KeyboardStyle {
    ...
    property color popupBackgroundColor: normalKeyBackgroundColor
    property color popupBorderColor: highlightedKeyBackgroundColor
    property color popupTextColor: textOnSecondaryColor
    property color popupHighlightColor: highlightedKeyBackgroundColor
